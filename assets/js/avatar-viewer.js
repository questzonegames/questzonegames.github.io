...
(function () {
  ...
  function mount(container, opts) {
    ...
    // 'legs' sits BEFORE 'boots' and BEFORE 'body' — each layer renders
    // over the one before it: boots (e.g. Green Ornate Shoes) go over the
    // trouser leg (e.g. Ornate Green Suit Bottoms), and a top (e.g. White
    // T-shirt) goes over a bottom's waistband (e.g. Grey Tracksuit
    // Bottoms), the way a real shirt is tucked in/worn outside trousers,
    // not the other way around.
    const SLOT_ORDER = ['back', 'legs', 'boots', 'body', 'necklace', 'head', 'gloves', 'mainHand', 'offHand', 'accessory'];
